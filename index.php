...
<html>
<head>
<title>Login Page - SHU HRM</title>
...
<body>
	<div class="main-wthree">
		<div class="container">
			<h1 class="text-center text-white">SHU Human Resource Management System - Admin Panel</h1>
		<div class="sin-w3-agile">
			...
			<form action="controller/login.php" method="post">
				...
				<div class="clearfix"></div>
					...
					<div class="footer">
						<p>Developed by Asaduzzaman | Dept of CSE | SHU | All Rights Reserved &copy; <?= date("Y") ?> </p>
					</div>
		</div>
		</div>
	</div>
