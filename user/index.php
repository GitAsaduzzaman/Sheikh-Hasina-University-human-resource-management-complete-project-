...
<title>Employee Login - SHU HRM</title>
<style>
    html{
        min-height: 100%;
        width:100%;
...
<body>
    ...
    <h1 class="text-white">SHU Human Resource Management System - Employee Panel</h1>
    <br>
    <br>
<div class="login-block">
    ...
    <div class="clearfix"></div>
				<h5 class="text-center"><a href=".." class="text-black" >Login as an Admin</a></h5>
				<div class="clearfix"></div>
</div>
</body>
